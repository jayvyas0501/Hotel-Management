...
import { managerRoomActions } from "../../../Constant/manager";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 bg-gradient-to-br from-gray-100 to-gray-200 py-8 px-4 overflow-y-auto">
        <div className="max-w-7xl mx-auto text-center mb-8">
          <h1 className="text-4xl font-extrabold text-gray-800 mb-2">Room Management</h1>
          <p className="text-gray-600 text-lg">Manage all your hotel room operations here.</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {managerRoomActions.map((action, index) => (
            <div
              key={index}
